...
// cc main.c -L/usr/local/lib/  -I/usr/local/include -I/minilibx-linux  -lmlx -lXext -lX11 -lm -lz
...
int	main()
{
  ...
  if (!(im2 = mlx_xpm_file_to_image(mlx,"minilibx-linux/test/open.xpm",&xpm1_x,&xpm1_y)))
    {
      printf(" !! KO !!\n");
      exit(1);
    }
